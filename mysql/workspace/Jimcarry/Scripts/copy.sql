...
alter table tbl_storage add column storage_address_number int;
...
storage_file_path varchar(500),
storage_file_org_name varchar(500),
storage_file_uuid varchar(500) unique,
...
INSERT INTO jimcarry.tbl_notice
(notice_title, notice_content, notice_writer, notice_regist, notice_update)
VALUES('sdfs', 'dfsdf', 'ㅇㅇㅇㅇㅇ', curdate(), curdate());

INSERT INTO jimcarry.tbl_review
(user_id, storage_id, review_title, review_context, review_write_date, review_edit_date)
VALUES(1, 1, '테스트입니다', '테스트입니다', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


INSERT INTO jimcarry.tbl_file
(storage_id, file_path, file_org_name, file_uuid)
VALUES(2, 'asdf.img', '파일이름', 'ㅇ');
...
/*1이면 true 외래키 설정 0이면 false 해제*/
set FOREIGN_KEY_CHECKS = 1;
truncate table tbl_user; 
truncate table tbl_storage;
truncate table tbl_storage_file; 
drop table tbl_storage_file;
truncate table tbl_inquiry;
truncate table tbl_inquiry_file;  
