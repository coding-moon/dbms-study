...
select * from tbl_enquiry_file;


INSERT INTO kids.tbl_user
(user_identification, user_password, user_email, user_phoneNumber, user_address, user_register_date)
VALUES('hds','ddd', 'ddd', '01012345678', 'ahsdjkfh', CURRENT_TIMESTAMP);

INSERT INTO kids.tbl_user
(user_identification, user_password, user_email, user_phoneNumber, user_address, user_register_date)
VALUES('hdd', 'dfdf', 'asdf', 'sdfsf', '01023454564', CURRENT_TIMESTAMP);

INSERT INTO kids.tbl_user
(user_identification, user_password, user_email, user_phoneNumber, user_address, user_register_date)
VALUES('hda', 'sdf', 'sdfa', 'asdf', '1346545456', CURRENT_TIMESTAMP);




INSERT INTO kids.tbl_customer_notice
(notice_title, notice_context, notice_date, notice_alter_date)
VALUES('sdf', 'sdffdfdfdfdff', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


select * from tbl_customer_enquiry;
truncate table tbl_customer_enquiry; 
select * from tbl_user;
select * from tbl_customer_notice;
