...
VALUES(SEQ_PET.NEXTVAL, '강아지', '뽀삐', 3, '감기', 4);

INSERT INTO TBL_PET
(PET_NUMBER, PET_TYPE, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_NUMBER)
VALUES(SEQ_PET.NEXTVAL, '고양이', '톰', 1, '장염', 4);

INSERT INTO TBL_PET
(PET_NUMBER, PET_TYPE, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_NUMBER)
VALUES(SEQ_PET.NEXTVAL, '쥐', '햄토리', 4, '배탈', 5);

INSERT INTO TBL_PET
(PET_NUMBER, PET_TYPE, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_NUMBER)
VALUES(SEQ_PET.NEXTVAL, '원숭이', '킹콩', 2, '목', 5);
...
INSERT INTO ANIMAL
(ANIMAL_ID, ANIMAL_NAME, ANIMAL_TYPE, ANIMAL_PHONE)
VALUES(SEQ_ANIMAL.NEXTVAL, '호랑', '호랑이', '12.21');

INSERT INTO ANIMAL
(ANIMAL_ID, ANIMAL_NAME, ANIMAL_TYPE, ANIMAL_PHONE)
VALUES(SEQ_ANIMAL.NEXTVAL, '뽀삐', '강아지', '01045671234');
